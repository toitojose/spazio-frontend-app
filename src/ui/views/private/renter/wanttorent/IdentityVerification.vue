<template>
  <RenterProcessLayout :current-step="2">
    <div class="flex flex-col-reverse lg:flex-row lg:space-x-6">
      <div class="mx-auto flex flex-col space-y-6 lg:w-2/3">
        <!-- Subir Foto Personal -->
        <div>
...
import { Button, FileUpload, FloatLabel, InputText, Message } from 'primevue';
import { ref } from 'vue';
